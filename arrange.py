...
df = pd.DataFrame(data, columns= ['Summary','Issue key','Issue Type','Client','Project','Role Title','Role ID','IQN','Status','POC','Resource Start Date','Role Created Date','Resource End Date'])
